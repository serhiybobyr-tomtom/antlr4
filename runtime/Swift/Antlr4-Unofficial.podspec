...
Pod::Spec.new do |s|
  s.name             = 'Antlr4-Unofficial'
  s.version          = ENV['ANTLR4_VERSION'] || '4.10.1-ext'
  s.summary          = 'Unofficial ANTLR runtime for iOS and macOS.'
  ...
  s.source           = { :git => 'https://github.com/serhiybobyr-tomtom/antlr4.git', :tag => s.version.to_s }
